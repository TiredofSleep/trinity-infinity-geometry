...
- **The proofs** — short Python scripts you can run on a laptop — live in [`../verification/`](../verification/). Run `python _verification_scripts/VERIFY_ALL.py` for the master suite.
- **The honest limits** — what the framework does *not* do — are in [`../04_meta/`](../04_meta/). Read this before deciding whether you find the work credible.
...
- **For practical use** — there are applications-by-domain in [`../01_orientation/for_founders.md`](../01_orientation/for_founders.md), but the framework is research-stage; it is not productized.
