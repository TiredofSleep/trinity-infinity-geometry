...
2. **Read [`../FORMULAS_AND_TABLES.md`](../FORMULAS_AND_TABLES.md)** — every D-number with cross-reference.
3. **Read individual papers as they land here.**
4. **For honest scope**, read [`../8_speculations/README.md`](../8_speculations/README.md) — what the framework is NOT.
