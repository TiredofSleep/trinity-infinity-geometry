...
Cross-references:
- [`../../FORMULAS_AND_TABLES.md`](../../FORMULAS_AND_TABLES.md) Volume F (Higgs / VEV); the constants table.
- [`../../2_for_physicists/README.md`](../../2_for_physicists/README.md) §3 (dark sector); §7 (z\* layers).
- [`../../8_speculations/README.md`](../../8_speculations/README.md) §2.3 (z\* layer choice as open problem); §2.4 (dark-sector match as empirical comparison).
