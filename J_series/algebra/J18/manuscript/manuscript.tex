...
$\sig = (0)(3)(8)(9)(1\,7\,6\,5\,4\,2)$ and the explicit
...
\item \emph{STRUCTURAL RHYME.}  Theorem~\ref{thm:role-fib}'s
$\{-F_{6}, -F_{7}\} = \{-8, -13\}$ Fibonacci split and
Proposition~\ref{prop:per-orbit}'s $\{-7, -8\}$ TIG-prime split
are recorded as table-specific identities in the sense of
Definition~\ref{def:table-spec}: they hold for the canonical
...
(C6) the involution sanity data ($\sig^{2}$ of period 3 on the
$6$-cycle, $\sig$-swap of $O_{1}, O_{2}$).
