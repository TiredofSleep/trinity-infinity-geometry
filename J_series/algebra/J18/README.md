# J18 — Two Crossing Decompositions of a -21 Invariant on Z/10Z with the sigma^2-Triadic Refinement
...
- **J02** — *Joint Closure, Per-Coordinate Fuse Data, and a Closed-Form Algebraic Attractor of Two Commutative Binary Operations on Z/10Z* (submitted to *Algebraic Combinatorics*; landed 2026-05-12). Establishes the canonical TS_8, BH_10 tables and the corrected substrate frame.
- **J26** — *The LATTICE Operator and Paradoxical Information Algebras: A Substrate-Internal Framework on Z/10Z* (submitted to *Algebra Universalis*; WP9 Volume I). Source of the per-element BH_10-period values that determine Table 1, and of the `0/200` random-table check used for Definition 3.4.
...
**Per-venue cap warning:** This is the 2nd *Algebraic Combinatorics* paper this quarter (after J02). Within cap; submission feasible.
...
- [x] Dependencies → J02 cited as "submitted to *Algebraic Combinatorics* (landed)"; J26 as "submitted to *Algebra Universalis*"
...
- [x] Per-venue cap check: 2nd *Algebraic Combinatorics* paper this quarter (after J02)
- [ ] Submitted
