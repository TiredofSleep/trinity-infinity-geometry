# Cover letter — J27: The Multiplicative-Unit Sub-Magma C = (Z/10Z)* and Its Contrast with the Joint 4-Core {0, 7, 8, 9}
...
- **J02 / J35** (Joint 4-Core, *Algebraic Combinatorics* / *Journal of Algebra*): proves the joint 4-core {0, 7, 8, 9} is the unique 4-element jointly TSML/BHML-closed subset; this paper contrasts C with that 4-core.
- **J07** (Flatness Theorem T* = 5/7, *Journal of Pure and Applied Algebra*): supplies the wider derivation of T* = 5/7; this paper's §5 generator-selection result depends only on T* < 1.
