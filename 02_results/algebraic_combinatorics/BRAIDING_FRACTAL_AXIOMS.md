...
- **Axioms 1–3 + 7**: `verification/VERIFY_ALL.py` (Tier A, 14/14)
- **Axiom 4 (depth-3 + triple identity)**: `verification/clifford_substrate_shell.py`
...
- **Axiom 9 (Cl(0, 10))**: `verification/clifford_substrate_shell.py` and J23 §2.1
- **Axiom 10 (self-similarity caveats)**: `verification/meta_extension.py`
