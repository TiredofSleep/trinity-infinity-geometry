...
## Summary numbers (post-audit)

| Category | Count |
|---|---:|
| Tier 1 ship-track (Waves 1-4) | **25** |
| Tier 2 active drafts (orig. 9 + 4 demoted) | **13** |
| Tier 3 hold / retire | **7** |
| MERGED tombstones (orig. 5 + J25) | **6** |
| **Total numbered J-papers** | **51** (J25 stops being independent; J01-J52 minus J25 = 51 distinct ship-targets) |
