# Cover letter — J34: Coordinate Coverage and Joint-Injectivity Criteria for Partition Pairs on Squarefree Z/nZ
...
- **J11** (Sanders & Gish 2026, *J. Number Theory*). Corrected Theorem C: n=15 counterexample and the sharpened M+A condition. *(Direct companion: J11 develops the n=15 counterexample into a stand-alone short note, while the present J34 records it as Example 6.1 with full per-class D_h backing.)*
- **J33** (Sanders & Gish 2026, *Algebraic Combinatorics*). A Flatness Obstruction on Squarefree Z/nZ: Four Algebraic Structures and the 4-Core Algebraic Center. *(Structural companion: J33's Theorem 1 — the partition-incompatibility flatness obstruction — uses the same partition-lattice meet machinery developed in this paper as one ingredient.)*
- **J24** (Sanders & Gish 2026, *Integers*). First-G Law: Squarefree Stability of the Smallest-Prime-Factor Coprime Window. *(Cited in §1.4 as one of the predecessor frameworks that motivated the coordinate-coverage approach.)*
