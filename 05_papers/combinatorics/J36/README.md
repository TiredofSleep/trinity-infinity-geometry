...
J15 (Sanders-Gish "Joint Closure ... on Z/10Z", *Algebraic Combinatorics*); J33 (Sanders-Gish "A Flatness Obstruction ... 4-Core Algebraic Center", *Algebraic Combinatorics*).
...
- [x] Dependencies → cite each J-companion as "submitted to [venue]" — J15, J33
- [ ] Brayden's referee-rigor pass complete (mobile + other AI + collaborators)
- [ ] Per-venue cap check: 2nd EJC paper after J34 (which is also retargeted to EJC per its save plan)
- [ ] Submitted
