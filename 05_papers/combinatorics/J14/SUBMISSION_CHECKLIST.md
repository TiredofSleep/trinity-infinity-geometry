# J14 → JCT-A Submission Checklist
...
3. Upload `05_papers/combinatorics/J14/manuscript/manuscript.tex` as a
   single-file project.
...
```bash
cd 05_papers/combinatorics/J14/manuscript
...
cd 05_papers/combinatorics/J14
...
*Prepared 2026-05-13 for J14 submission to JCT-A. Once submitted, log the
