# Cover letter — J50: A 5-Dimensional CRT Fourier Embedding of Z/10Z
...
The TIG/CK research program is shipping a coordinated 55-paper sequence (J14-J55) over Summer 2026. The papers most relevant as already-submitted companions to this manuscript are:

- J15 — Sanders & Gish, *Joint Closure, Per-Coordinate Fuse Data, and a Closed-Form Algebraic Attractor*, submitted to *Algebraic Combinatorics*. Defines the substrate (Z/10Z, σ, W) including the σ-permutation used in the spectral functional and the 4-core {0, 7, 8, 9} cited in §7.
