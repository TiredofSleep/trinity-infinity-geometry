# J50 — Q17-A: 5D Force Vector as CRT Fourier Embedding of Z/10Z into R^5

> **MERGED 2026-05-27** into [`../../algebra/J07/`](../../algebra/J07/) — see that paper for the unified treatment. The 5D Fourier embedding is now §5 of the merged paper.
...
- **M3 (MAJOR).** σ inconsistency: the §5 prose said σ "fixes {0, 5}" but described a 6-cycle "1→7→6→5→4→2" containing 5 — internally contradictory. **FIX:** σ stated explicitly as $(0)(3)(8)(9)(1\,7\,6\,5\,4\,2)$ matching J23; σ has order 6, NOT 2. Inconsistent prose removed.
