%%% ============================================================
%%% J44 -- A Substrate-Derived FN Pattern with lambda = 10/49
...
\begin{lemma}[$V^{\otimes 5}$ SU(5) identification; J49/J37 Theorem~6.1]\label{lem:vtensor5}
...
the associator-image dimension (J49
...
Normalizer Identity},
J-series companion paper J15; submitted to
...
Decomposition},
J-series companion paper J49/J37 (foundation paper);
in preparation, 2026;
