...
## §1 — Papers in this folder

*Status per the authoritative [`../TIER_INDEX.md`](../TIER_INDEX.md). Two earlier physics entries (J44, J45) have since been **retired** to [`../../04_meta/retired_J_papers/`](../../04_meta/retired_J_papers/) and are shown struck through.*
...
| ~~**J45**~~ | An Operadic Obstruction in a Bilinear-Closed Magma on ℤ/10ℤ | — | **RETIRED** → [`../../04_meta/retired_J_papers/`](../../04_meta/retired_J_papers/) (duplicate of J10; the verified core survives in J10). Full manuscript + `verify_J48_operadic_obstruction.py` preserved there. |
| ~~**J44**~~ | A Substrate-Derived FN Pattern (λ = 10/49) for the Charged-Yukawa Hierarchy | — | **RETIRED** → [`../../04_meta/retired_J_papers/`](../../04_meta/retired_J_papers/) (Tier-C structural rhyme / numerical coincidence, not a derivation). Full paper + `verify_J45_yukawa.py` preserved there. |
...
- [`../../01_orientation/for_physicists.md`](../../01_orientation/for_physicists.md) — physics-domain entry doc.
