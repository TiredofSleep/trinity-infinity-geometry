...
| **J03** | The Discrete Fejér Quotient on Squarefree Moduli: Spectral Characterization, Layered Divisors, and the Asymptotic Corridor Average (merged J03 + J04) | *Integers — Electronic Journal of Combinatorial Number Theory* | merged 2026-05-13 |
| ~~J04~~ | ~~Full-Period Cancellation of $R(k, f)$ and the spf-Localization for Squarefree Moduli~~ | ~~*Integers*~~ — **merged into J03 on 2026-05-13** (pre-merger files preserved per never-delete at `J04/`) | absorbed 2026-05-13 |
