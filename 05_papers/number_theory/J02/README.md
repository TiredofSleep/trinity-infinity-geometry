...
```bash
cd 05_papers/number_theory/J02/manuscript
...
- TIG repo: `05_papers/algebra/J07/` — companion σ-character spectral architecture
- TIG repo: `05_papers/algebra/J01/` — corpus centerpiece (joint closure + 4-core)
