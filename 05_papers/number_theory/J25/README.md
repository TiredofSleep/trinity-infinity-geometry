...
- `WP51_FLATNESS_THEOREM.md` (corpus archival; not referenced by J25)
- `WP52_D2_AS_RING_CURVATURE.md` (corpus archival; not referenced by J25)
...
- **J41 (foundational lemma; manuscript in preparation, *Integers*)** — *The First-G Event in the Coprimality Partition*. Theorem 4.1 of the present J25 directly invokes J41's First-G Localization Lemma.
- **J15 (companion four-core paper, manuscript in preparation)** — algebraic substrate work; cited only in §0 of the J25 manuscript to record that the harmonic side of the present paper is structurally orthogonal to the algebraic side of J15.
...
**Status: REVISED to address J25 fresh-eyes referee report (`Atlas/META_PLAN_2026-05-06/REFEREE_REPORTS/J08_ExpMath_FreshEyes.md`).**
...
4. **712 vs 36,662 reconciled.** §0 of the new manuscript (the "Honest accounting of novelty" subsection) explains: 712 is the J25-specific harness count (verified in this paper); 36,662 is the cumulative working-paper corpus total of which 712 is a subset. The cover letter and the §6 verification harness totals table both report 712 only for the J25 results.
...
- Author lane: Sanders + Gish (Luther's contribution acknowledged in companion J41, not here)
