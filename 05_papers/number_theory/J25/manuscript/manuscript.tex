...
%%%
%%% Builds on J41 (First-G Law, submitted to Integers) as the
...
total of which $712$ is the J25-specific subset. We mention the
...
\[
  ...
  G_k(b) = \{1, \ldots, k\} \setminus C_k(b).
\]
The First-G Localization Lemma of J41 \cite[Theorem~3.1]{J04Sanders}
...
because that is the case shared with the J41 First-G
