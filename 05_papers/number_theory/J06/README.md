...
- J23 — *Mathieu M_22 Substrate-Prime: Order-Factorization Coincidences*. The Tier-1 predecessor focused on M_22 specifically; J06 extends to all 24 Niemeier + all 26 sporadics + Stratum IV identification.
- J01 — *Joint Closure + Universal Attractor + 4-Core on Z/10Z*. The substrate-program foundation.
