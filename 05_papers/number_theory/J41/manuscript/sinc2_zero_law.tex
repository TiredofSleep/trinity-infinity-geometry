...
%%% (J41, Sanders + Gish 2026; companion submission to Integers).
%%% ============================================================
...
First-G Event Localization Theorem of \cite{J41} to obtain the
...
Localization Theorem of \cite{J41}, which states that for every
...
\cite{J41} for the algebraic version and full corollary structure
...
First-G companion \cite{J41}; we restate them in $\sinc^2$ language
...
statement proved in the First-G companion paper \cite{J41}:

\begin{quote}
\emph{First-G Event Localization Theorem \cite{J41}.} For every
...
The continuum-limit reading of \cite{J41} gives the harmonic
pre-echo function
...
squarefree $b \le 500$.
\newblock Electronic supplementary material to \cite{J41}, 2026.
...
First-G companion paper \cite{J41}. Verification script
