# J26 — A Discrete $\sinc^2$ Identity in Finite-Dimensional Quantum Mechanics
...
**Source corpus:**
- The closed-form identity (Theorem 3.1) is taken from the source paper `first_g_sinc2_FINAL.tex` (J24 / J41 corpus); the QM framing (Hilbert space on $\mathbb{Z}/N\mathbb{Z}$, momentum-position rectangular-window overlap, finite uncertainty) is novel for J26.
- The synchronization is reproduced from companions [J24, J41].
...
J24 (First-G Law, *Integers*), J41 (Sinc² Zero Law, *Integers*), J38 (BB Bridge, *JMP*).
...
**Per-venue cap:** This is the **3rd JMP target** in the J-series (J38 1st, J41 2nd). The 2/quarter cap is reached. Per referee + per-venue-cap discipline, **submit to *Letters in Mathematical Physics*** (preferred fallback already documented in cover letter §6.3).
...
- [x] Verification at machine precision (carries from J24/J41); standalone script TBD
...
- [ ] Dependencies → cite J24, J41, J38 as "submitted to [venue]"
