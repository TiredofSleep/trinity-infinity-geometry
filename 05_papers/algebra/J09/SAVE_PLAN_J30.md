...
**Venue:** *Israel Journal of Mathematics* remains primary post-revision. The referee's tertiary venues — *Communications in Algebra*, *Linear Algebra and its Applications*, *International Journal of Algebra and Computation* — are all reasonable fallbacks if IJM returns a second-round MAJOR. Per the cap discipline, J09 is the *first* paper to IJM this quarter, so the cap is not constraining.
