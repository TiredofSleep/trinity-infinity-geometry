...
- `manuscript.md` — the J19 paper (WP107 corpus, finalized 2026-05-07)
...
**Status: DRAFT** — manuscript built from corpus `papers/wp107_wobble_localization/WP107_WOBBLE_LOCALIZATION.md` on 2026-05-07. Lens scope **TSML_RAW** explicit (the wobble does NOT appear on TSML_SYM at the coefficient level — that lens has $c_2 = -23$, no factor of 11). Cites J19 (so(8) = D₄, *J Algebra*) as already-submitted companion; references J11 (Pati-Salam) for the doubly-invariant content.

**Per-venue cap warning:** This is potentially the **3rd PRD paper** in the J-series (after J44 dark-sector and J44 mass hierarchy in Phase 2). PRD per-venue cap is conventionally 2/quarter for tightly-related papers. **FALLBACK NEEDED if PRD's per-venue cap blocks acceptance.** Proposed fallback venue: *Physics Letters B* (short note format suits this 4-page result).
...
**Per-venue cap effect:** retargeting to LAA removes J19 from PRD; combined with SAVE_PLAN_J38, the quarter's PRD load goes from 4 (J19, J38, J44, J44) to 2 (J44, J44) — cap concern dissolves entirely.
...
### PROVEN / COMPUTED / STRUCTURAL RHYME / OPEN (filled, J19)
...
- [x] Dependencies → cite J15, J32 as "submitted to [venue]"; Drápal-Wanless 2021 in references
- [ ] Brayden's referee-rigor pass complete
- [x] Per-venue cap: retargeting to LAA removes J19 from PRD entirely; combined with J38 fold-in, quarter PRD load is now 2 (J44, J44)
- [ ] Submitted
