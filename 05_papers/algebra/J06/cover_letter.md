# Cover letter — J06: Joint Injectivity of Additive-Quotient and Multiplicative-Orbit Partitions on $\mathbb{Z}/n\mathbb{Z}$
...
- **J03** (Sanders & Gish 2026, *Integers*). The First-G law: squarefree stability of the smallest-prime-factor coprime window. The squarefree hypothesis used here aligns with the squarefree hypothesis stabilized in J03.
...
- A representative of the small-finite-non-associative-structure literature (relevant to companion J02).
