...
The 200-table random sample reported in
\cite[N8]{SandersBridgeWP9} yielded zero reproductions of the
$(13, 8)$ split. A larger sample ($10^{4}$+) would be needed to
assert strong table-specificity; we currently treat the result as
table-specific in the sense of Definition~\ref{def:table-spec}
without claiming a probabilistic bound. The 200-table check should
be read as an indicative (not asymptotic) empirical observation.
\end{remark}
