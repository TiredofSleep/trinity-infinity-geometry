...
- **Companion four-core paper (Sanders + Gish, manuscript in preparation):** establishes the joint $\{0,7,8,9\}$-preservation and the broader algebraic family in which $\BH$ and $\TS$ are canonical members. Cited in §1 (closest published precedent paragraph) and §6 (open questions) of the J28 manuscript.
...
**Status: REVISED to address J28 fresh-eyes referee report (`Atlas/META_PLAN_2026-05-06/REFEREE_REPORTS/J09_AlgUni_FreshEyes.md`).**
