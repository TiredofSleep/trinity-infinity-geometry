# Cover letter — J49: A Commutative Non-Associative 4-Algebra over F_5 with Rigid Idempotent Decomposition
...
The main result (Theorem 3.1) is fully self-contained: each of the 9 claims has an inline mathematical proof. Companion submissions (J15, J20, J50) are mentioned only in §1.4 as related context for the broader research program; they are not load-bearing for this paper's main result.
