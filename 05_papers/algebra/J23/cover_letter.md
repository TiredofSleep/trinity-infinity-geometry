# Cover letter — J23: Mathieu M_22 Substrate-Prime: Order-Factorization Coincidences
...
- J15 (*Algebraic Combinatorics*) — Joint Closure, Per-Coordinate Fuse Data, and a Closed-Form Algebraic Attractor of Two Commutative Binary Operations on Z/10Z. Defines the substrate (Z/10Z, σ, W) and its substrate-prime distinction. The present paper depends on J15 only for the algebraic foundations; the non-genericity theorem is verifiable from this paper's §3 plus the binomial-tail computation in §4.
