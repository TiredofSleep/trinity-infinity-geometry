# Cover letter — J01: Joint Closure, a Universal Attractor, and an Algebraic Mixing Point for a Pair of Binary Operations on $\mathbb{Z}/10\mathbb{Z}$
...
- **J17** (Sanders + Gish 2026, *Algebraic Combinatorics*) — *Forcing Axioms and the Family of Commutative Non-Associative Magmas on $\mathbb{Z}/10\mathbb{Z}$ Preserving a Designated 4-Core.* The foundation paper that displays the three tables explicitly and proves the 9-axiom forcing theorem.
