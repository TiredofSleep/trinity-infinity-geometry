...
**(f) Resolve the cross-paper $D_4 / D_3 \times \mathbb{Z}_2$ inconsistency.** Per referee §3.5: J10's WP109 file states "6 distinct elements" with abstract structure $D_3 \times \mathbb{Z}_2$, contradicting J11's $D_4$ identification. The referee actually **vindicates J11** in the same paragraph (computing $P_{56}\sigma^3 = (1\,6\,2\,5)(4\,7)$, order 4, so $\langle P_{56}, \sigma^3\rangle = D_4$ of order 8). The fix is therefore not in J11 — it's a one-line correction to J10's WP109. Add a footnote in J11 §1.2: *"This identification of $\langle P_{56}, \sigma^3 \rangle$ with the dihedral group of order 8 is verified explicitly by computing $P_{56}\sigma^3$; see Appendix A.1. The contrasting claim in WP109 §2 is in error and is corrected in J10's revision."*

**(g) Cite the so(10) closure (currently "WP103") in a refereed source.** The referee §3.3 raises this as a major concern: "WP103" appears only as an internal-tree path. The save path is to cite J09 explicitly:

> *Sanders, B.R., Mayes. (2026). "so(10) Lie-Algebraic Closure of TSML+BHML's Antisymmetric Generators." Submitted to* Israel J. Math.

(per the J11 README §3 "Dependencies: J09"). When J09 lands on arXiv, the citation gets a DOI and the issue is closed. If J09 takes longer, J11 could appendicize a self-contained proof of the so(10) closure (the closure proof is short — antisymmetrization, dimension count, simplicity check via Killing form).
...
J11 was the 1st *Adv Math* paper this quarter (per README §6). After retargeting to *J. Algebra*, the cap on *Adv Math* is unaffected. *J. Algebra* itself: this is a fresh venue for the J-series (no prior submissions). Cap not in play.
...
- [ ] Cite J09 (Sanders + Mayes, *Israel J Math*) for the so(10) closure per §2(g); appendicize the short proof if J09 not yet on arXiv
...
- [ ] Update J-series ordering doc (target-venue field for J11)
