...
The J11 paper is **"Decomposition of the Lens-Pair Commutator [TSML, BHML] under $D_4$ on $\mathbb{Z}/10\mathbb{Z}$: Path A (~83%) Doubly-Invariant Gauge Sector + Path B (~16%) sigma_outer-Broken Higgs Sector + ~1% Interaction"**.
...
- `manuscript.md` — the J11 paper (fully rewritten 2026-05-08 per SFM v1.1 §10)
...
J29 (so(8) = $D_4$, *J. Algebra*), J09 (so(10) = $D_5$, *Israel J. Math*).
...
- **Cite J09** (Sanders + Gish, *Israel J Math*) as already-submitted companion for the so(10) closure.
