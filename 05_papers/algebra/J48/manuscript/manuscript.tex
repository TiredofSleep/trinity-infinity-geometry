% J48 — F_p Structural Invariance of a Commutative Non-Associative
...
% Companions cited as already-submitted: J15, J32, J27
...
%   (g) Reconcile title (J48) and remove J50 source comments;
...
Finite Magmas}, submitted to \emph{JCT-A}, 2026 (J32).

\bibitem{SandersGishFlatness} B.~R.~Sanders, M.~Gish,
\emph{Flatness Theorem: The Forced 2$\times$2 Torus on $\Z/10$},
submitted to \emph{Journal of Pure and Applied Algebra}, 2026 (J27).
