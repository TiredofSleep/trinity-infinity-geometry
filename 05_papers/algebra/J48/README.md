# J48 — F$_p$ Structural Invariance of a Commutative Non-Associative 4-Algebra Arising from the 4-Core of Z/10Z

> **MERGED 2026-05-27** into [`J08/`](../J08/) — see that paper for the unified treatment combining J48 and J49. The Lens-Invariant Skeleton and Aut Variation theorems are now §§2-3 of the merged paper.
...
**Tier:** -- (MERGED 2026-05-27 into J08)
...
J15 (Algebraic Combinatorics — combinatorial origin); J32 (J. Combin. Theory A — Crossing Lemma); J27 (J. Pure Appl. Algebra — Flatness Theorem). Drápal-Wanless 2021 (JCTA 184, 105510) cited as closest published precedent.
...
- (f) REDUCE dependency on inaccessible companion papers (J15, J37); make J48 self-contained on algebraic content.
- (g) RECONCILE J50/J48 numbering in .tex source.
...
**Family-Structure context:** J48 maps the **substrate-size boundary** (FAMILY_STRUCTURE_v1.md §3.5) inward to F_p for p ∈ {2, 3, 5, 7, 11, 13}. F_5 is the distinguished member of the family (D74 ring extension); the F_p-invariance of the structural skeleton is the boundary-mapping result.
...
### PROVEN / COMPUTED / STRUCTURAL RHYME / OPEN (filled, J48 — see manuscript §1.1)
...
### Lens-ownership paragraph (filled, J48 — see manuscript §1.2)
...
- [x] Manuscript .tex finalized (defensive-exposition rewrite 2026-05-07: T_F5 inline; worked associator example; 5-line numpy/sympy snippet; |Aut(V_p)| tabulated for verified primes; F_5 specificity of |Aut|=40 explicit; axial-algebra framing removed; Drápal-Wanless 2021 neighborhood cited; title retitled per save plan §6; J50→J48 source comment fixed; \author blocks merged; HARM/VOID mnemonics removed from Definition 2.1 in favor of $e_0, e_2$ throughout).
...
- [x] Dependencies → cite J15 (Alg. Combin.), J32 (JCTA), J27 (JPAA), Drápal-Wanless 2021 (JCTA 184, 105510).
