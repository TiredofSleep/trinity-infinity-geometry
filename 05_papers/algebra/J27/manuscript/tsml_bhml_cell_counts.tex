...
%%%   J14: sigma rate theorem (submitted to JCTA)
%%%   J15: four-core consolidated (submitted to Algebraic Combinatorics)
...
the four-core companion paper~\cite{J15}, which is lens-dependent
...
\cite{J15}. There the relevant quantity is the size of the chain
...
while the chain count of \cite{J15} is an interaction-dependent
...
sub-magma chain count of the four-core companion \cite{J15}, which
...
manuscript and to \cite{J14,J15}, 2026.
