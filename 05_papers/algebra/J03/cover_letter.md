...
- **Lo Shu D₄ orbit mod 3** (companion J29): 3 ETP profile classes {60, 179, 313}, no profile-14 closure realizer at order 3.
- **σ-magma at order 10** (companion J04): the conjectural unique identity-free + rigid commutative-quasigroup realizer of Family C = closure of commutativity.
- **Linear classification** (companion J05): catalog of $(ax+by+c) \bmod n$ profiles; ℤ/n stable at 32 for $n ≥ 5$.
...
- This is a methodology paper. The detailed case studies are companion papers (J29, J04, J05).
