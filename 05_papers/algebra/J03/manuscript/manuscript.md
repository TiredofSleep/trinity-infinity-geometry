...
## §3 Worked example 1: The Lo Shu D₄ orbit modulo 3 (J29)
...
## §4 Worked example 2: σ-magma at order 10 (J04)
...
- **Profile 14 (Family C realization) requires non-linear σ_n constructions** at orders 5-10, plus the J01 BHML/CL_STD tables at order 10.
...
- Sanders, B.R. & Gish, M. (2026). [J29] *The Lo Shu D₄ Orbit Modulo 3: Four Distinct Magmas and a Cumulant Spectrum.* Submitted to *Mathematics Magazine*.
- Sanders, B.R. & Gish, M. (2026). [J04] *Algebraic Rigidity of the σ-Magma on $\mathbb{Z}/10\mathbb{Z}$.* Submitted to *Semigroup Forum*.
- Sanders, B.R. & Gish, M. (2026). [J05] *ETP Profile Structure of Linear Magmas $(ax+by+c) \bmod n$.* Submitted to *Experimental Mathematics*.
