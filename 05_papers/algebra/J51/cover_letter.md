...
The three results, together, characterize the canonical $\sigma$-permutation completely at the spectral / period level. They form **Layer 4** of the 6-layer Q-series architecture and are foundational citations for the runtime attractor [J33], the Q17-B Clay-bridge essay [J52], the $\sigma$-rate theorem [J14] companion citations, and the WP100s tower's $D_4 = \langle P_{56}, \sigma^3 \rangle$ analysis.
...
- **[J14]** — $\sigma$-rate theorem (JCT-A). Uses $\sigma^6 = \mathrm{id}$.
- **[J32]** — TSML 73 / BHML 28 (Exp Math). Layer 5 reference.
- **[J50]** — Q17-A 5D Force Vector (AMM). Direct citation.
- **[J33]** — Closed-form runtime attractor (Math of Comp). Layer 6 reference.
- **[J52]** — Q17-B Clay Bridge (L'Enseignement Math). Direct citation.
- **[J45]** — 6-DOF Synthesis (Notices AMS). Cross-reference.
- **[J46]** — Microtubule $Q_c = T^*$ (J Theor Biol). Cross-reference (period statistic feeds $T^*$ derivation).
