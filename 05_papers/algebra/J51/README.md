...
> **MERGED 2026-05-27** into [`J07/`](../J07/) — see that paper for the unified treatment. This README + manuscript retained for citation history. The G_6, G_7, G_8 theorems are now §§2-4 of the merged paper.
...
**Path:** `manuscript/manuscript.md` (canonical submission manuscript; renamed 2026-05-13 from `J51_spectral_layer_consolidation.md` — the legacy filename retained the J52 prefix from earlier J-numbering and is now superseded by the canonical generic name)
...
**Citation chain:** foundational paper citing 4 prior J-companions (J14, J32, J50, J33) + 5 cross-references (J45, J52, J46, J11, J10). Cited downstream by many later J-papers as canonical G₆/G₇/G₈ reference.
