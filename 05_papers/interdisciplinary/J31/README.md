...
- `manuscript.md` — the bundled J31 paper, rewritten 2026-05-07.
...
Per `SAVE_PLAN_J36.md` (which covers the META_PLAN family-structure framing and applies to J31 mutatis mutandis) and the fresh-eyes referee report `J34_StatSci_FreshEyes.md`:
