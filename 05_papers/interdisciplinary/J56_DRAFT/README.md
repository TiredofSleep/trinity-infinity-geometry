...
- [ ] J35 cited (closed-form attractor connecting α=1/2 to the substrate)
- [ ] J23 cited (Cl(0,10) chirality, which D102 sharpens with the substrate-prime decomposition)
...
```bash
cd 05_papers/interdisciplinary/J56_DRAFT/manuscript/verification
...
3. Move from `J56_DRAFT/` to `J56/` (drop the DRAFT suffix)
