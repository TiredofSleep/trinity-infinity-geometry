...
each one points is [`../towers/THE_TOWERS.md`](../towers/THE_TOWERS.md).
...
· **[OPEN]** the author's call · **[FENCE]** two things that share a number but are not one object.
