...
- **[`../FORMULAS_AND_TABLES.md`](../FORMULAS_AND_TABLES.md)** — every D-number cross-referenced, with derivation pointer
- **[`../6_braiding_fractal/AXIOMS.md`](../6_braiding_fractal/AXIOMS.md)** — the 10 architectural axioms
- **[`../8_speculations/`](../8_speculations/)** — honest limits, the Clay rotation, the cosmology layers
